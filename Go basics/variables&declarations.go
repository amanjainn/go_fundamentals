// Variables in  GO
// 1.  In Go a variable belongs and it's created at runtime
// 2.  A declared variable must be used or we get an error
// 3.  There are two ways to declare variables in  Go
